...
public class CodeGenerator {
    //生成文件所在项目路径
    private static String baseProjectPath = "/xxx/xxx/xxx";

    //基本包名
    private static String basePackage="com.xxx.xxx.project";
    //作者
    ...
    private static String url = "jdbc:oracle:thin:@localhost:1521:xxx";
